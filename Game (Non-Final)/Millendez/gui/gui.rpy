...
define gui.accent_color = '#f63fed'
...
define gui.hover_color = '#f224e8'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#f224e8'
...
## The colors used for dialogue and menu choice text. (at the pop-up frame when player wants to go back to main menu/exit the game)
...
## The size of the game's title. (Title Screen)
...
define gui.main_menu_background = Movie(play="gui/main_menu_ani.webm")
...
define gui.choice_button_text_hover_color = "#c82f65"
...
define gui.slot_button_width = 445
define gui.slot_button_height = 485
...
define config.thumbnail_width = 393
define config.thumbnail_height = 283
